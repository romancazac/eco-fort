...
let slider_about = new Swiper('.main-baners__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
function scroll_scroll() {
	...
	let fix = document.querySelector('.main-baners');
	if (header !== null) {
		if (src_value > 10) {
			header.classList.add('_scroll');
			fix.classList.add('_fix');
		} else {
			header.classList.remove('_scroll');
			fix.classList.remove('_fix');
		}
	}
